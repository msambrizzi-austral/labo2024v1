...
TS_strategy_baseline_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202107, 202106, 202105, 202104, 202103, 202002, 202001, 201912, 201911, 
                               201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901)


  param_local$train$training <- c(202105, 202104, 202103, 202102, 202002, 202001, 201912, 201911, 201910, 
...
TS_strategy_baseline_202107 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202105, 202104, 202103, 202002, 202001, 201912, 201911, 201910, 
                               201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902)


  param_local$train$training <- c(202103, 202102, 202002, 202001, 201912, 201911, 201910, 201909, 
...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    min_data_in_leaf = c( 100L, 5000L, "integer" )
  )
...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_baseline( "DT0001-sem5", "competencia_2024.csv.gz")
  CA_catastrophe_baseline( "CA0001-sem5", "DT0001-sem5" )

  DR_drifting_baseline( "DR0001-sem5", "CA0001-sem5" )
  FE_historia_baseline( "FE0001-sem5", "DR0001-sem5" )

  TS_strategy_baseline_202109( "TS0001-sem5", "FE0001-sem5" )

  HT_tuning_baseline( "HT0001-sem5", "TS0001-sem5" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-sem5", c("HT0001-sem5","TS0001-sem5") )
...
corrida_baseline_semillerio_202109( "basem01_5" )
