...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_4", "FE0001_4" )

  HT_tuning_guantesblancos( "HT0002_4", "TS0002_4" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_4", c("HT0002_4", "TS0002_4") )
...
#corrida_guantesblancos_202107( "gb02_4" )
